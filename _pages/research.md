...
feature_row1:
  - image_path: /assets/images/exp_setup.png
    ...
    excerpt: 'There is a ubiquitous rule in lanthanide (Ln) extraction: __Heavier elements extracted better than the Lighter ones__. Although it is widely known empirical knowledge, there is not so many studies to understand this phenomena in nano-scale. __I used synchrotron-sourced X-rays to characterize the adsorption of Er (heavier Ln) and Nd (lighter Ln) to a negativel charged monolayer__.
    <br/>
